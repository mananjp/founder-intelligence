...
const COLOR: Record<ClaimStatus, string> = {
  verified: "var(--fi-verified)",
  supported: "var(--fi-verified)",
  directional: "var(--fi-assumption)",
  conflicting: "var(--fi-conflicting)",
  inferred: "var(--fi-accent)",
  assumption: "var(--fi-assumption)",
  unverified: "var(--fi-muted)",
};
